                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-0 border border-gray-200 rounded-2xl overflow-hidden mb-12">
                        ...
                        <div class="p-6 bg-white">
                            ...
                            <div class="text-[11px] text-gray-500 mt-1 uppercase">{{ $contract->employe->poste }} — MATRICULE : {{ $contract->employe->numero_matricule }}</div>
                        </div>
                    </div>
                                ...
                                @if($contract->statut === \App\Models\Contrat::STATUS_SENT)
                                    <form action="{{ route('employer.contracts.sign', $contract) }}" method="POST" class="w-full flex flex-col items-end gap-4">
                                        ...
                                        <label class="flex items-center gap-3 cursor-pointer">
                                            ...
                                            <span class="text-[10px] text-gray-500 font-black uppercase tracking-tighter italic">Je valide et je signe ce contrat</span>
                                        </label>
                                        <button type="submit" 
